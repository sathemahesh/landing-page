  ...
  const events = [
    {
      ...
      description:
        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repudiandae ea exercitationem quidem dolores reprehenderit rem laudantium voluptate eveniet quis labore!",
  ...
  return (
    <div className="container mb-5 " style ={{marginTop:"10rem"}}>
      <div className="mb-5 text-center text-lg-start">
        <h4 className="Event" style={{ fontSize: "21px", color:"#F8669E" }}>
        ...
        <h2 className="mb-0 h2-style">
          <div className=" ">
            <span
              className="Event"
              style={{ color: "#333369",fontSize: "56px" }}
            >
              List of planned Events thay are
            </span>
          </div>
          <div>
            <span
              className="Event"
              style={{ color: "#F8669E", fontSize: "56px" }}
            >
              Expected
            </span>
          </div>
      ...
      {events.map((event, index) => (
        <div key={index} className="event-card mb-4 shadow-sm">
          <div className="row g-0">
            <div
              className="col-lg-3 col-md-4 col-sm-12  p-4 text-white text-center text-lg-start  ms_event_title1"
              style={{ backgroundColor: event.mahesh }}
            >
            ...
            <div className="col-lg-6 col-md-8 col-sm-12">
              <div className="p-4 text-start ">
                <h4
                  className="mb-2"
                  style={{ color: "#333369", fontSize: "21px" }}
                >
                  Introduce the Event
                </h4>
                ...
                <ul
                  ...
                  style={{ color: "#333369", fontSize: "16px" }}
                >
