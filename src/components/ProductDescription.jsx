            ...
            <div className="container">
                <div className="row mt-5">
                    ...
                    <div className="col-12 col-md-6 order-1 order-md-1 ">
                        <h1 className="title-style mt-5">{product.name}</h1>
                        <p className='p-para'>{product.dsc}</p>
                        <h3 className='category_style mb-4'>Category  <span className='ms-3'> cloths</span></h3>
                        <h3 className='price mb-4'>
                ...
                <div className="row mt-5 mb-4">
                    {/* Description Section */}
                    <div className="col-12 col-lg-8  mt-5 border_style1" style ={{height:"fit-content"}}>
                    ...
                    <div className="col-12 col-lg-4 mt-4 mt-lg-0  ">
                        <div className="col"><h4 className="rec text-center text-lg-start ms-4">Recent Products</h4></div>
